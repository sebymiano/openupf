...
typedef struct tag_fp_dns_header {
    uint16_t            id;             /* ID:����Ϊ16λ����һ���û����Ͳ�ѯ��ʱ���������� */
    fp_dns_flags        flags;          /* Flags:����16λ */
    uint16_t            ques;           /* QDCount:����16λ������������е������¼���� */
    uint16_t            answ;           /* ANCount:����16λ�����Ļش���еĻش��¼���� */
    uint16_t            auth;           /* NSCOUNT :����16λ��������Ȩ���е���Ȩ��¼���� */
    uint16_t            addrrs;         /* ARCOUNT :����16λ�����ĸ��Ӷ��еĸ��Ӽ�¼���� */
} fp_dns_header;
#pragma pack()
...
typedef struct tag_fp_dns_tail_response {
    fp_dns_rr_name_point    name;           /* C0 0C ����ָ��  */
    uint16_t                type;           /* ��ѯ���� */
    uint16_t                classtype;      /* ���� */
